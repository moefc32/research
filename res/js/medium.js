	...
	(function(t, n) {
		...
		(function(e) {
			...
			t.default = function() {
				return {
					view: function() {
						return e("div.medium-widget", [e(".medium-widget__wrapper", [e(r.default)])])
					}
				}
			}
		}).call(this, n(0))
					...
					t.default = function() {
						return {
							...
							view: function() {
								...
								return(0, o.chunk)(n, 1).map(function(n) {
					...
					t.default = function() {
						return {
							...
							ri: function(e) {
								...
								if(["author", "publishAt"].some(function(e) {
							...
							view: function(t) {
								...
								return "big" == i.picture && (a = ".medium-widget-article__column"), e(".medium-widget-article__item", [e(a, [e(o.default, {
									...
									config: i,
									url: r.url
								}), e(".medium-widget-article__content", [e("a", {
									href: r.url,
									target: "_blank"
								}, [e("h2.medium-widget-article__title", {
									title: r.title
								}, r.title)]), this.rwc("description", e(".medium-widget-article__description", r.description)), this.ri(e(".medium-widget-article__info", [this.rwc("publishAt", e(".medium-widget-article__date", this.date(r.publishAt)))]))])])])
							}
						}
					}
				}).call(this, n(0))
					...
					Object.defineProperty(t, "__esModule", {
						...
						return {
							...
							getPictureUrl: function() {
								var e = 100,
									t = "https://cdn-images-1.medium.com/fit/" + e + "/" + e + "/" + this.pictureId
								return t
							},
							view: function(t) {
